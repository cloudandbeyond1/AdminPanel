			...
			<Fragment>
				...
				<div className="form-head d-flex mb-3 mb-md-5 align-items-start">
					<div className="mr-auto d-none d-lg-block">
						...
						Back</Link >
						<h3 className="text-black font-w600 mb-0 fs-22 mb-2">List Product ID #5552351</h3>
						<Link to={"#"} className="mb-0 text-black font-w500" >Product  /</Link >
						<Link to={"#"} className="mb-0 font-w500" > Product Detaills </Link >
					</div>
									...
									<div className="card-body rounded" style={{background:"#3f4953"}}>
										<div className="row mx-0 align-items-center">
											<div className="media align-items-center col-xl-6 col-lg-5 px-0 mb-3 mb-md-0">
												<img className="mr-3 img-fluid rounded-circle" width="100" src="../../../../images/profile/5.png" alt="DexignZone" />
											...
											<table className="table items-table">
													...
													<td>
														<div className="media">
															<Link to={"/ecom-product-detail"} >
																<img className="mr-3 img-fluid rounded" width="85" src="/images/card/pic5.jpg" alt="DexignZone" />
															</Link >
															<div className="media-body">
												...
												<tr>
													<td>
														<div className="media">
															<Link to={"/ecom-product-detail"} >
																<img className="mr-3 img-fluid rounded" width="85" src="../../../../images/card/pic6.jpg" alt="DexignZone" />
															</Link >
															<div className="media-body">
																<small className="mt-0 mb-1 font-w500"><Link to={"#"} className="text-primary" >MAIN COURSE</Link ></small>
												...
												<tr>
													<td>
														<div className="media">
															<Link to={"/ecom-product-detail"} >
																<img className="mr-3 img-fluid rounded" width="85" src="../../../../images/card/pic7.jpg" alt="DexignZone" />
															</Link >
															<div className="media-body">
																<small className="mt-0 mb-1 font-w500"><Link to={"#"} className="text-primary" >MAIN COURSE</Link ></small>
								...
								<div className="card">
									<div className="card-body border-bottom">
										<div className="media align-items-center">
											<img className="mr-3 rounded-circle" src="../../../../images/profile/6.jpg" width="90" alt="" />
											<div className="media-body">
