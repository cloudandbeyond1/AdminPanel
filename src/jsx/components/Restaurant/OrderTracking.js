...
import mapImage from "../../../images/svg/map.svg";
import profileImage from "../../../images/profile/5.jpg"
			...
			<Fragment>
				...
				<div className="form-head d-flex mb-3 mb-md-5 align-items-start">
					<div className="mr-auto d-none d-lg-block">
						...
						<Link to={"#"} className="mb-0 font-w500" > Order Details </Link >
					</div>
										...
										<ul className="timeline">
											<li>
												...
												<Link to={"#"} className="timeline-panel text-muted" >
													...
													<p className="fs-14 mb-0 ">Fri, 5 May 2023, 11:49 AM</p>
												</Link >
											</li>
											<li>
												<div className="icon bg-primary"></div>
											...
											<li className="border-dark">
												...
												<Link to={"#"} className="timeline-panel text-muted" >
													...
													<p className="fs-14 mb-0 ">Fri, 5 May 2023, 01:24 PM</p>
												</Link >
											</li>
											<li>
								...
								<div className="card">
									<div className="card-body rounded" style={{background:"#3f4953"}}>
										<div className="row mx-0 align-items-center">
                                            ...
                                            <img className="mr-3 img-fluid rounded-circle" width="100" src={profileImage} alt="DexignZone" />
											...
											<table className="table items-table">
												...
												<tr>
													<td>
														<div className="media">
                                                            ...
                                                            <img className="mr-3 img-fluid rounded" width="85" src={pic5} alt="DexignZone" />
															</Link >
															<div className="media-body">
																...
																<div className="star-review fs-14">
																	...
																	<span className="ml-3 text-dark">(450 reviews)</span>
																</div>
															</div>
														</div>
													</td>
													...
													<td>
														<h4 className="my-0 text-secondary font-w600">₹300</h4>
													</td>
												...
												<tr>
													<td>
														<div className="media">
															<Link to={"/ecom-product-detail"} >
                                                            <img className="mr-3 img-fluid rounded" width="85" src={pic6} alt="DexignZone" />
															</Link >
															<div className="media-body">
																<small className="mt-0 mb-1 font-w500"><Link to={"#"} className="text-primary" >MAIN COURSE</Link ></small>
																...
																<div className="star-review fs-14">
																	...
																	<i className="fa fa-star text-orange"></i>
																	<i className="fa fa-star text-orange"></i>
																	<span className="ml-3 text-dark">(454 reviews)</span>
																</div>
															</div>
														</div>
													</td>
													...
													<td>
														<h4 className="my-0 text-secondary font-w600">₹350</h4>
													</td>
													<td className="d-md-none d-lg-table-cell">
														<h4 className="my-0 text-secondary font-w600">₹350</h4>
													</td>
												...
												<tr>
													<td>
														<div className="media">
															<Link to={"/ecom-product-detail"} >
																<img src={pic6} className="mr-3 img-fluid rounded" width="85" alt="DexignZone" />
															</Link >
															<div className="media-body">
																<small className="mt-0 mb-1 font-w500"><Link to={"#"} className="text-primary" >MAIN COURSE</Link ></small>
													...
													<td>
														<h4 className="my-0 text-secondary font-w600">₹450</h4>
													</td>
													<td className="d-md-none d-lg-table-cell">
														<h4 className="my-0 text-secondary font-w600">₹450</h4>
													</td>
							...
							<div className="col-xl-12 col-md-6 col-xxl-6">
								<div className="card">
									<div className="card-body border-bottom">
                                        ...
                                        <img className="mr-3 rounded-circle" src={profile6} width="90" alt="" />
											<div className="media-body">
